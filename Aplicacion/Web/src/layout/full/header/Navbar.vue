<template>
	<header class="gridx">
      ...
      <div slot="title" class="themelogo">
        <img :src="logo" v-if="logo" width="100" height="60" alt="Dashboard"/>
        <span class="logo-text margin-l" v-if="title">{{ title }}</span>
      </div>
      <!---
      Mobile toggle
      --> 
      ...
      <vs-dropdown  vs-trigger-click left class="cursor-pointer pr-2 pl-2 ml-1 mr-md-3">
         <a class="text-white-dark user-image" href="#">
           <img src="@/assets/Img/Usuarios/profile-user-white.svg" alt="User"/>
          </a>
        <vs-dropdown-menu class="topbar-dd">          
